...
add_action('after_setup_theme', function () {
  $theme_settings = [
     ...
     */
    'menu_locations' => [
      'primary' => __('Primary Menu', 'equicore'),
    ],
     ...
     * https://github.com/digitoimistodude/equicore#custom-taxonomies
     */
    'taxonomies' => [
     ...
     *
     * See the instructions:
     * https://github.com/digitoimistodude/equicore#custom-post-types
     */
    'post_types' => [
      // 'Your_Post_Type',
    ],
  ...
  $theme_settings = apply_filters('EquiCore_theme_settings', $theme_settings);
