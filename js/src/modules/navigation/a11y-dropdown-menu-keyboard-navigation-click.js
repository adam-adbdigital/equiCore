    ...
    item.addEventListener('keyup', (e) => {
      ...
      if (
        ...
        if (thisElement.parentNode.previousElementSibling) {
          ...
          if (
            mainLevelSubMenu &&
            mainLevelSubMenu.querySelectorAll('.menu-item-has-children')
          ) {
            mainLevelSubMenu
              .querySelectorAll('.menu-item-has-children')
              .forEach((subMenu) => {
                // Get the previous item's dropdown
                const previousItemDropdownToggle =
                  subMenu.querySelector('.dropdown-toggle');
                ...
                previousItemDropdownToggle.setAttribute(
                  'aria-label',
                  `${EquiCore_screenReaderText.expand_for} ${previousItemDropdownToggle.innerText}`
                );
          ...
          const previousItemDropdownToggle =
            previousItem.querySelector('.dropdown-toggle');
      ...
      if (e.key === 'Enter' || e.type === 'click') {
        ...
        if (thisElement.getAttribute('aria-expanded') === 'false') {
          ...
          thisElement.setAttribute(
            'aria-label',
            `${EquiCore_screenReaderText.collapse_for} ${linkLabel}`
          );
        } else {
          ...
          thisElement.setAttribute(
            'aria-label',
            `${EquiCore_screenReaderText.expand_for} ${linkLabel}`
          );
        }
