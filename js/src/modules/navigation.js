 ...
 * The original, accessible navigation module for equicore
 */
...
const navClick = () => {
  ...
  a11yDropdownMenuKeyboardNavigationClick(
    menuItems,
    focusableElementsforDropdown
  );
  ...
  function navToggle(e) {
    ...
    if (e.type === 'click' || e.keyCode === 13) {
      ...
      if (
        ...
        document
          .getElementById('nav-toggle')
          .setAttribute('aria-label', EquiCore_screenReaderText.expand_toggle);
      }
...
export { navSticky, navDesktop, navClick, navMobile };
