...
} // end EquiCore_move_jquery_into_footer
...
function enqueue_theme_scripts()
{
  ...
  wp_localize_script('scripts', 'EquiCore_screenReaderText', [
  ...
  wp_localize_script('scripts', 'EquiCore_externalLinkDomains', THEME_SETTINGS['external_link_domains_exclude']);
} // end EquiCore_scripts
...
function enqueue_polyfills()
{
  ...
  if (file_exists(get_theme_file_path(get_asset_file('legacy.js')))) {
    wp_register_script('EquiCore_legacy', '', [], filemtime(get_theme_file_path(get_asset_file('legacy.js'))), false);
    wp_enqueue_script('EquiCore_legacy');
    wp_add_inline_script('EquiCore_legacy', $script, true);
  }
