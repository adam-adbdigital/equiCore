...
class Nav_Walker extends \Walker_Nav_Menu
{
	...
	public static function fallback($args)
	{
		...
		$fallback_output .= '<li class="menu-item"><a href="' . esc_url(admin_url('nav-menus.php')) . '" class="nav-link" title="' . esc_attr__('Add a menu', 'equicore') . '">' . esc_html__('Add a menu', 'equicore') . '</a></li>';
		$fallback_output .= '</ul>';
